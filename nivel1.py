...
#
# Created: Sat Dec 12 15:38:37 2015
...
class Ui_Nivel1(object):
    def setupUi(self, Nivel1):
        ...
        Nivel1.setMinimumSize(QtCore.QSize(0, 0))
        Nivel1.setMaximumSize(QtCore.QSize(16777215, 16777215))
        icon = QtGui.QIcon()
        ...
        self.gridLayout.addWidget(self.but_sair, 5, 0, 1, 5)
        self.but_rec = QtGui.QPushButton(self.centralwidget)
        self.but_rec.setObjectName(_fromUtf8("but_rec"))
        self.gridLayout.addWidget(self.but_rec, 4, 3, 1, 2)
        ...
        self.gridLayout.addWidget(self.but_entr, 4, 0, 1, 3)
