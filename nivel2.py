...
#
# Created: Sat Dec 12 09:10:41 2015
...
class Ui_nivel2(object):
    def setupUi(self, nivel2):
        ...
        self.retir.setGeometry(QtCore.QRect(0, 0, 681, 223))
        ...
        self.cad.setGeometry(QtCore.QRect(0, -103, 667, 295))
        ...
        self.gridLayout_5.addWidget(self.lineEdit_4, 2, 3, 1, 1)
        ...
        self.statusBar = QtGui.QStatusBar(nivel2)
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(0, 0, 255))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.WindowText, brush)
        ...
        nivel2.setStatusBar(self.statusBar)
