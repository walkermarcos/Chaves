...
#
# Created: Sat Nov  7 13:28:48 2015
...
class Ui_Mainentrega(object):
    def setupUi(self, Mainentrega):
        ...
        self.but_cod = QtGui.QPushButton(self.centralwidget)
        self.but_cod.setObjectName(_fromUtf8("but_cod"))
        self.gridLayout.addWidget(self.but_cod, 12, 0, 1, 3)
    ...
    def retranslateUi(self, Mainentrega):
        ...
        self.but_cod.setText(_translate("Mainentrega", "Cod.Barras", None))
